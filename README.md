...
- [x] Why would you use class component over function components (removing hooks from the question)?
    In the case i get hired at a company whos app was already using them and they dont want to refactor
- [x] Name three lifecycle methods and their purposes.
    render returns JSX, componentDidMount is used for initializing state and in general anything that needs to be done for your app to be ready to use and only happens once
    and componentWillUnmount is for cleaning up any listeners, observers or promises that may be pending or active before unmounting a component, not doing so will cause a memory leak
- [ ] What is the purpose of a custom hook?
    to reduce redundancy in repetitive functions, creating dry code.
